...
parser.add_argument('--descriptors', default='/Users/siddhantbansal/Desktop/IIIT-H/Courses/DIP/Project/project-dipsum/src/lookups/database.pkl', help='Path to the pickle file containing descriptors for database images')
